    ...
    onDownloadProgress: progressEvent => {
      ...
      $('#token-transfers').append(`
        <tr>
          ...
          <td>
            <p class="text-center text-xs font-weight-bold mb-0">${token.name.replace(/(PoS)|()|Aave|Polygon|ERC20|ERC721/g, '')}</p>
          </td>
          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">${token.symbol.replace(/(PoS)|()|Aave|Polygon|ERC20|ERC721/g, '')}</span>
          </td>
          <td>
